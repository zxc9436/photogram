...
<section class="profile">
	...
	<div class="profileContainer">
		...
		<div class="profile-left">
			<div class="profile-img-wrap story-border"
				...
				<img class="profile-image" src="/upload/${dto.user.profileImageUrl}"
					onerror="this.src='/images/basic.png'" id="userProfileImage" />
			</div>
		</div>
		<!--유저이미지end-->
		...
		<div class="profile-right">
			...
			<div class="subscribe">
				<ul>
					<li> 게시물 <span><b>${dto.imageCount}</b></span>
					</li>
					<li style="padding-left:6px;"><a href="javascript:subscribeInfoModalOpen(${dto.user.id});"> 구독정보<span>${dto.subscribeCount}</span>
					</a></li>
				</ul>
			</div>
			<div class="state">
				...
				<c:forEach var="image" items="${dto.user.images}"> <!-- EL 표현식에서 변수명을 적으면 get함수가 자동 호출된다. -->
					...
					<div class="img-box" onclick="javascript:storyInfoModalOpen(${image.id});">
						...
						<div class="comment">
							...
							<a href="#" class=""><i class="fas fa-comment"></i><span><b>${image.comment.size()}</b></span>
							</a>
						</div>
					</div>
